...
import enn_pipeline_regression_1a_grad_clip_absent as enn_pipeline_regression
...
def main_run_func():
    with wandb.init(project=PROJECT_NAME, entity=ENTITY) as run:
        ...
        var_square_loss = enn_pipeline_regression.experiment(dataset_cfg, model_cfg, train_cfg, enn_cfg, direct_tensor_files, model_predictor, device, seed_training)
