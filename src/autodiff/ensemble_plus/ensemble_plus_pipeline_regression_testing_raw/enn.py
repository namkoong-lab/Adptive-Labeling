...
class ensemble_with_matching_ensemble_prior(nn.Module):
    def __init__(self, input_size, basenet_hidden_sizes, n_classes, num_ensembles, seed_ensemble, seed_prior_ensemble, alpha):
        super(ensemble_with_matching_ensemble_prior, self).__init__()
    ...
    def forward(self, x, index):
        ...
        return main_output + self.alpha * prior_output
